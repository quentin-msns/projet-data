...
def lemmatize_text(text: str) -> str:
    ...
    return " ".join(lemmas)
df = pd.read_csv("question2.csv", encoding="utf-8", sep=';')
...
# Supposons que ton dataframe s'appelle df et qu'il n'a qu'une seule colonne
...
df_top10000.drop(columns=['word_count'], inplace=True)# 4️⃣ (Optionnel) Supprime la colonne word_count si tu ne la veux plus
df_top10000 = df_top10000.map(lemmatize_text) # on lemmatize 2 fois
print(df_top10000)
